...
const HeptaButton = ({
  ...
  const baseColor = color ? color : COLORS.secondary;
  const dsbldColor = disabledColor ? disabledColor : COLORS.background;

  return (
    <HeptaButtonContainer className={disabled ? "disabled" : ""}>
      <svg
      ...
      >
        <path
          fill={disabled ? dsbldColor : baseColor}
        ...
        <text
          fill={COLORS.primary}
          fontWeight="bold"
          fontSize={textSize ? textSize : "1.5em"}
          y="50%"
          x="50%"
