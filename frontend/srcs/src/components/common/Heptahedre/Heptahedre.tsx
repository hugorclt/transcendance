...
import { HeptahedreContainer } from "./HeptahedreStyle";
import { THeptrahedreProps } from "./THeptahedre";

function Heptahedre({ firstText, secondText, width }: THeptrahedreProps) {
  return (
    <HeptahedreContainer width={width}>
      <svg
        width="100%"
        height="auto"
        ...
        <h1 style={{ color: COLORS.primary, textAlign: "center" }}>
          {firstText}
          <br />
          <span style={{ color: COLORS.background }}>{secondText}</span>
        </h1>
    </HeptahedreContainer>
  );
}
